...
fill("Red")
text("This is an IPL final between RCB and CSK.")
text("RCB is batting at 140/7.")
text("you have 3 wickets to chase the target of 180")
text("Press space to to start game")
text("You have to press space every time to get ball")
text("You can move batsman with arrow keys")
